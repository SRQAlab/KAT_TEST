...
WebUI.callTestCase(findTestCase('Cura_Healthcare/LaunchApplication'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Appointment')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Tokyo CURA Healthcare Center'), 
...
WebUI.callTestCase(findTestCase('Cura_Healthcare/Logout'), [:], FailureHandling.STOP_ON_FAILURE)
