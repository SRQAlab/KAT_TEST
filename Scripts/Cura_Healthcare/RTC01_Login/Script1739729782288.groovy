...
WebUI.navigateToUrl(GlobalVariable.HLS_URL)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), GlobalVariable.HLS_PASSWORD)
