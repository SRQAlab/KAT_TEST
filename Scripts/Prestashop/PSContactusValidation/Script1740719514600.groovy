...
WebUI.verifyElementText(findTestObject('Object Repository/Prestashop/Page_PrestaShop Live Demo/li_Invalid email address'), 
    'Invalid email address.')

WebUI.verifyElementPresent(findTestObject('Object Repository/Prestashop/Page_PrestaShop Live Demo/li_Invalid email address'), 
    0)
