...
WebUI.scrollToElement(findTestObject('Object Repository/RSAcademy/Page_Lets Shop/button_Cart 1'), 0)

WebUI.click(findTestObject('Object Repository/RSAcademy/Page_Lets Shop/button_Cart 1'))

WebUI.verifyElementText(findTestObject('RSAcademy/Page_Lets Shop/h3_ZARA COAT 3'), 'ZARA COAT 3')

WebUI.verifyElementPresent(findTestObject('RSAcademy/Page_Lets Shop/h3_ZARA COAT 3'), 0)
