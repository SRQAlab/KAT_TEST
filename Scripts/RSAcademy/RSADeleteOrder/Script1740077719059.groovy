...
WebUI.scrollToElement(findTestObject('Object Repository/RSAcademy/Page_Lets Shop/button_ORDERS'), 0)

WebUI.click(findTestObject('Object Repository/RSAcademy/Page_Lets Shop/button_ORDERS'))

WebUI.verifyElementText(findTestObject('RSAcademy/Page_Lets Shop/td_ZARA COAT 3'), 'ZARA COAT 3')

WebUI.verifyElementPresent(findTestObject('RSAcademy/Page_Lets Shop/td_ZARA COAT 3'), 0)
