...
WebUI.navigateToUrl('https://rahulshettyacademy.com/client/auth/login')
...
WebUI.sendKeys(findTestObject('Object Repository/RSAcademy/Page_Lets Shop/input_Password_userPassword'), Keys.chord(Keys.ENTER))
