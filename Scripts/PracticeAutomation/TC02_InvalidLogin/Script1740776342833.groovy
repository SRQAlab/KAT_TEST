...
WebUI.verifyElementText(findTestObject('Object Repository/PracticeAutomation/Page_Test Login  Practice Test Automation/div_Your password is invalid'), 
    'Your password is invalid!')

WebUI.verifyElementPresent(findTestObject('Object Repository/PracticeAutomation/Page_Test Login  Practice Test Automation/div_Your password is invalid'), 
    0)

WebUI.setText(findTestObject('Object Repository/PracticeAutomation/Page_Test Login  Practice Test Automation/input_Username_username'), 
    'student')

WebUI.setText(findTestObject('Object Repository/PracticeAutomation/Page_Test Login  Practice Test Automation/input_Password_password'), 
    '')
